        ...
        return """
                {
                  ...
                  "steps": [
                    ...
                    { "tempId": "step_5", "masterStepId": "5", "name": "Xây dựng đề cương học phần (CLO)", "code": "S5_CLO", "screenCode": "S5_CLO", "executorRole": "LECTURER", "approverRole": "MANAGER", "isRequired": true, "orderNo": 5, "prerequisiteStepCodes": ["S2_PLO", "S3_XacDinhCauTruc_KhoiLuongKienThuc"] },
                  ...
                  "nodes": [
                    ...
                    { "id": "step_5", "type": "state", "position": { "x": 1900, "y": 150 }, "data": { "label": "Xây dựng đề cương học phần (CLO)", "orderNo": 5, "screenCode": "S5_CLO", "performerRole": "LECTURER", "approverRole": "MANAGER", "prerequisiteStepCodes": ["S2_PLO", "S3_XacDinhCauTruc_KhoiLuongKienThuc"] } },
